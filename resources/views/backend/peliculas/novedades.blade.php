        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-8 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        ...
                        <form action="{{ route('novedades.pelis') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="date" name="primary_release_date_gte" value="{{ $filters['primary_release_date_gte'] ?? '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-900">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Fecha Hasta</label>
                                <input type="date" name="primary_release_date_lte" value="{{ $filters['primary_release_date_lte'] ?? '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md text-gray-900">
                            </div>
                            <div>
                    ...
                    @if(count($peliculas) === 0 && !isset($error))
