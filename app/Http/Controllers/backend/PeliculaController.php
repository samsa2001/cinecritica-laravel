...
class PeliculaController extends Controller
{
    ...
    public function verNovedades()
    {
        ...
        $query = "discover/movie?language=es-ES&primary_release_date.gte=2024-01-01&sort_by=vote_count.desc&vote_count.gte=5&with_original_language=es&page=";
        $query = "discover/movie?language=es-ES&primary_release_date.gte=2024-06-01&&primary_release_date.lte=2025-01-01&sort_by=vote_count.desc&vote_count.gte=200&page=";
