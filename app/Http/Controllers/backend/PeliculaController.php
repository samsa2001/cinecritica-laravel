...
class PeliculaController extends Controller
{
    ...
    public function verNovedades()
    {
        ...
        $query = "discover/movie?language=es-ES&primary_release_date.gte=2024-01-01&primary_release_date.lte=2025-01-01&sort_by=vote_average.desc&vote_average.gte=7&vote_count.gte=10&page=";
